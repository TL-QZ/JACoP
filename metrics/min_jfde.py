...
class minJFDE(Metric):
    ...
    def update(self,
        ...
        if return_individual:
            return {
                'per_mode_joint_sum': per_mode_joint,
                'batch_sum': batch_sum,
                'batch_count': torch.tensor(batch_count, device=pred.device, dtype=per_mode_joint.dtype),
